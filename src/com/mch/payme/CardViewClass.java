...
public class CardViewClass extends RelativeLayout {
    ...
    public CardViewClass(final LinearLayout parent, PaymentCard scannedCard, Context context, int index)
    {
        super(context);
        ...
        View view = inflater.inflate(R.layout.card_view, this, true);
        ...
        this.closeButton.setOnClickListener(new OnClickListener()
        {
            ...
            {
                parent.removeView(CardViewClass.this);
            }
        });
    }
